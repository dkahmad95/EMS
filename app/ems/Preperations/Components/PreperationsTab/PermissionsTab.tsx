    ...
    <div>
      ...
      <div className="flex gap-2 mb-4 bg-white p-4 rounded shadow">
        ...
        <Button
          ...
          className={`flex items-center gap-2 text-white ${
            permission.trim() ? "bg-green-700 hover:bg-green-600" : "bg-gray-400 cursor-not-allowed"
          }`}>
      ...
      <ul className="space-y-2">
        {permissions.map((perm, index) => (
          <li key={index} className="p-3 bg-white shadow rounded text-gray-700 flex justify-between items-center">
