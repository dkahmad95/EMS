            ...
            <div className="w-full md:w-1/2">
                ...
                <div className="mt-4">
                    ...
                    <div className="relative">
                        ...
                        <EyeIcon
                            className={`cursor-pointer absolute left-10 top-1/2 h-[18px] w-[18px] -translate-y-1/2 ${showPassword ? "text-green-800" : "text-gray-500"
                                }`}
                ...
                {/* Footer Links */}
                {/* <div
                        className="flex h-8 items-end justify-between mt-2"
                        aria-live="polite"
                        aria-atomic="true"
                        dir="rtl"
                        >
